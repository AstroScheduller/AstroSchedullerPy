...
def get_cmd(indicator="scheduller 2.1.1"):
...
skyMapSunLoc(range(1, 10800, 2600))


# In[37]:


deg_to_sun("J0332+5434", Timestamp(1627110881), rtnList = False)


# In[53]:


astropy.coordinates.get_sun(Timestamp(1627110881)).transform_to(AltAz(obstime=Timestamp(1627110881), location=shanghai)).to_string("decimal").split(" ")
...
plt.plot(123.643, 19.8438, "ro")
plt.plot(53.24754, 54.5787025, "bo")
plt.show()
